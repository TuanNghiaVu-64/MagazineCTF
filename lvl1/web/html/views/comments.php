                ...
                <div class="panel-body">
                    <form name="myForm" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
                        ...
                        <div class="mar-top clearfix">
                            ...
                            <label for="file"><a class="btn btn-trans btn-icon fa fa-paperclip add-tooltip"></a></label>
                        ...
                        ?>
                            <div class="media-block">
                                ...
                                <div class="media-body">
                                    ...
                                    <?php
                                    if (!empty($row["image"]))
                                        echo "<a href=\"" . $row["image"] . "\" class=\"ht-tm-element btn btn-danger btn-shadow text-mono\" download><span class=\"fa fa-download mr-2\" ></span>" . basename($row["image"]) . "</a>";
                                    ?>
                                    <hr>
                                </div>
                            </div>
